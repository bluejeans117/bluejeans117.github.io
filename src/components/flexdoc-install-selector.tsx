...
const targets: InstallTarget[] = [
  {
    ...
    packageName: '@prauga/flexdoc-client', version: '2.8.0', registry: 'npm',
    registryHref: 'https://www.npmjs.com/package/@prauga/flexdoc-client',
    installLabel: 'Install the client', install: 'npm install @prauga/flexdoc-client@2.8.0', codeLanguage: 'tsx',
    ...
    note: 'FlexDoc 2.8 ships FlexDoc, the low-level ApiClient and the persistent ApiClientWorkspace, including nested folders, collection variables, hierarchical auth and canonical Postman import.',
...
export function RequestPanel() {
  return <ApiClient initialRequest={{ method: 'GET', url: 'https://api.example.com/pets' }} />;
    ...
    exampleHref: 'https://github.com/Prauga/flexdoc/tree/js/v2.8.0/packages/client',
  },
  {
...
export function RequestWorkspace() {
  return <ApiClientWorkspace persistenceKey='my-api' initialRequest={{ method: 'GET', url: '{{baseUrl}}/pets' }} />;
    ...
    note: 'ApiClientWorkspace wraps the same canonical editor with collections, nested folders, variables, inherited auth/OAuth, scripts, tests, history, Postman Collection v2.1/environment import and optional IndexedDB persistence.',
    exampleHref: 'https://github.com/Prauga/flexdoc/tree/js/v2.8.0/examples/api-client',
  },
  {
    id: 'express', runtime: 'JavaScript / TypeScript', framework: 'Express',
    packageName: '@prauga/flexdoc-backend', version: '2.8.0', registry: 'npm',
    registryHref: 'https://www.npmjs.com/package/@prauga/flexdoc-backend',
    installLabel: 'Install the Node adapter', install: 'npm install @prauga/flexdoc-backend@2.8.0', codeLanguage: 'js',
  ...
  },
  {
    ...
    packageName: '@prauga/flexdoc-backend', version: '2.8.0', registry: 'npm',
    registryHref: 'https://www.npmjs.com/package/@prauga/flexdoc-backend',
    installLabel: 'Install the Node adapter', install: 'npm install @prauga/flexdoc-backend@2.8.0', codeLanguage: 'ts',
...
setupHonoFlexDoc(app, '/docs', {
  ...
  },
  {
    ...
    packageName: '@prauga/flexdoc-cli', version: '0.4.0', registry: 'npm',
    registryHref: 'https://www.npmjs.com/package/@prauga/flexdoc-cli',
    installLabel: 'Install the CLI', install: 'npm install --save-dev @prauga/flexdoc-cli@0.4.0', codeLanguage: 'bash',
  ...
  },
  {
    ...
    packageName: 'Prauga.FlexDoc.AspNetCore', version: '0.3.0', registry: 'NuGet',
    registryHref: 'https://www.nuget.org/packages/Prauga.FlexDoc.AspNetCore',
    installLabel: 'Install the NuGet package', install: 'dotnet add package Prauga.FlexDoc.AspNetCore --version 0.3.0', codeLanguage: 'csharp',
  ...
  },
  {
    ...
    packageName: 'com.prauga.flexdoc:flexdoc-spring-boot-starter', version: '0.6.0', registry: 'Maven Central',
  ...
  },
  {
    ...
    packageName: 'com.prauga.flexdoc:flexdoc-jaxrs', version: '0.6.0', registry: 'Maven Central',
  ...
  },
  {
    ...
    packageName: 'com.prauga.flexdoc:flexdoc-jvm', version: '0.6.0', registry: 'Maven Central',
  ...
  },
  {
    ...
    install: `implementation("com.prauga.flexdoc:flexdoc-jvm:0.6.0")`,
    codeLanguage: 'kotlin',
  ...
  },
  {
    ...
    packageName: 'prauga-flexdoc', version: '0.5.0', registry: 'PyPI',
    registryHref: 'https://pypi.org/project/prauga-flexdoc/',
    installLabel: 'Install the Python adapter', install: 'pip install prauga-flexdoc==0.5.0', codeLanguage: 'python',
  ...
  },
  {
    ...
    packageName: 'prauga/flexdoc', version: '0.3.0', registry: 'Packagist',
    registryHref: 'https://packagist.org/packages/prauga/flexdoc',
    installLabel: 'Install with Composer', install: 'composer require prauga/flexdoc:^0.3.0', codeLanguage: 'php',
  ...
  },
  {
    ...
    packageName: 'prauga-flexdoc', version: '0.3.0', registry: 'RubyGems',
    registryHref: 'https://rubygems.org/gems/prauga-flexdoc',
    installLabel: 'Add the gem', install: `gem "prauga-flexdoc", "~> 0.3.0"`, codeLanguage: 'ruby',
  ...
  },
  {
    ...
    packageName: 'github.com/prauga/flexdoc/adapters/go', version: '0.4.0', registry: 'Go module',
    registryHref: 'https://pkg.go.dev/github.com/prauga/flexdoc/adapters/go',
    installLabel: 'Install the Go module', install: 'go get github.com/prauga/flexdoc/adapters/go@v0.4.0', codeLanguage: 'go',
  ...
  },
  {
    ...
    packageName: 'prauga-flexdoc-axum', version: '0.4.0', registry: 'crates.io',
    registryHref: 'https://crates.io/crates/prauga-flexdoc-axum',
    installLabel: 'Install the crate', install: 'cargo add prauga-flexdoc-axum@0.4.0', codeLanguage: 'rust',
  ...
  },
  {
    ...
    packageName: 'prauga-flexdoc-actix', version: '0.3.0', registry: 'crates.io',
    registryHref: 'https://crates.io/crates/prauga-flexdoc-actix',
    installLabel: 'Install the crate', install: 'cargo add prauga-flexdoc-actix@0.3.0', codeLanguage: 'rust',
  ...
  },
  {
    ...
    packageName: 'prauga_flexdoc', version: '0.3.0', registry: 'Hex',
    registryHref: 'https://hex.pm/packages/prauga_flexdoc',
    installLabel: 'Add the Mix dependency', install: `{:prauga_flexdoc, "~> 0.3.0"}`, codeLanguage: 'elixir',
