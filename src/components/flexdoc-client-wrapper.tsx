...
function fullSurfaceOptions(theme: 'light' | 'dark', title: string): FlexDocRendererOptions {
  return {
    ...
    logo: { url: logo, alt: 'FlexDoc 2.2', maxHeight: 34, maxWidth: 120, clickable: false },
    customCss: '.flexdoc-root { --portfolio-flexdoc-surface: 2.2; }',
    ...
    tryIt: {
      ...
      requestInterceptor: (request) => ({
        ...request,
        headers: { ...request.headers, 'X-FlexDoc-Portfolio': '2.2-full-surface' },
      }),
    },
    codeSamples: {
      enabled: true,
    ...
    footer: {
      copyright: 'Prauga FlexDoc 2.2 full-surface showcase',
      link: [
...
export function FlexDocClientWrapper({
  ...
  title = 'FlexDoc 2.2 full-surface showcase',
